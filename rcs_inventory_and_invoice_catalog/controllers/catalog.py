...
class ProductCatalogController(Controller):
    ...
    @http.route('/product/catalog/order_lines_info', auth='user', type='json', methods=['POST'])
    def product_catalog_get_order_lines_info(self, res_model, order_id, product_ids=[1,2,3,4,5,6], **kwargs):
        ...
        return order._get_product_catalog_order_line_info(
            product_ids, **kwargs,
        )

    @http.route('/product/catalog/update_order_line_info', auth='public', type='json', methods=['POST'])
